        ...
        <section class="listings">
            <div class="wrapper">
                ...
                <table>
                    ...
                    $sel = "SELECT h.hire_id, h.rent, h.status, h.datetime, h.start_time, h.end_time, c.car_name, c.car_type FROM hire h, cars c WHERE h.car_id=c.car_id AND h.client_id = " . $_SESSION['id'];
                    $rs = $conn->query($sel);
                    ?>
